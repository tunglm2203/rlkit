...
def main():
    ...
    n_trajectories = 1000
    horizon = 0
    # data_folder = 'randlarger_pair_sim_src.{}'.format(n_trajectories * (horizon + 1))
    data_folder = 'randlarger_pair_sim.{}'.format(n_trajectories * (horizon + 1))
    ...
    data_folder_real = 'randlarger_pair_real.{}'.format(n_trajectories * (horizon + 1))

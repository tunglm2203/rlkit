...
def main():
    ...
    data_folder = 'randlarger_pair_real.{}'.format(n_trajectories * (horizon + 1))
    ...
    # Create environment
    env_tgt = gym.make(env_id, random_init=False,
    ...
    for i in tqdm(range(re_generate_start_epoch, n_trajectories)):
        ...
        while True:
            ...
            if t == 0:
                ...
                o, _, _, _ = env_tgt.step(env_tgt.action_space.sample())

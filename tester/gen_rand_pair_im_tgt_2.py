...
def main():
    ...
    n_trajectories = 50
    horizon = 9     # 19
    data_folder = 'rand_pair_sim_tgt.{}'.format(n_trajectories * (horizon + 1))
    ...
    # Create environment
    env_sim = gym.make(env_id, random_init=True)
    ...
    for i in tqdm(range(re_generate_start_epoch, n_trajectories)):
        ...
        while True:
            ...
            obs = dict(ee_pos=o['state_observation'][:2],
                       obj_pos=o['state_observation'][2:])
            episode.append(obs)

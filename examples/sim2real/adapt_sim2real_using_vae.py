...
def main(args):
    ...
    variant = dict(
        ...
        rand_src_dir='randlarger_img_real.10000',
        rand_tgt_dir='randlarger_img_real.10000',

        pair_src_dir='randlarger_pair_sim.1000',
        pair_tgt_dir='randlarger_pair_real.1000',
        test_ratio=0.1,
        vae_kwargs=dict(
            input_channels=3,
        ...
        default_path='/mnt/hdd/tung/workspace/rlkit/data/vae_s2r_10000rand_1000pair/',
